...
export default function PlatformCard({
    ...
    const handleCopyId = (e: React.MouseEvent) => {
        ...
        setCopied(true);
        toast.success(`Platform ID copied: ${platform.id.slice(0, 8)}...`);
            ...
            <div className="relative flex flex-col justify-between h-full gap-4">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-border/40 text-xs text-muted-foreground">
                    <Badge
                        variant="secondary"
                        className={cn(
                            "px-2.5 py-0.5 text-[11px] font-medium tracking-wide rounded-md border capitalize",
                            theme.badgeStyle
                        )}
                    >
                    ...
                    >
                        ...
                        <span>#{platform.id.slice(0, 6)}</span>
                    </button>
                </div>
            </div>
        </div>
